...
public:
	/** Helper functions */
	VIRTUALCURSOR_API static void EnableAnalogCursor(class APlayerController* PC, TSharedPtr<SWidget> WidgetToFocus);
	VIRTUALCURSOR_API static void DisableAnalogCursor(class APlayerController* PC);
